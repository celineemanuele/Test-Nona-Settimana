                ...
                <div>
                    <div className="row">
                        <div className="col col-12 text-start mb-2">
                            <button type="button" className="btn btn-sm footer-button rounded-0 mt-3 text-secondary border border-secondary">
                                Service Code
                            </button>
                        </div>
                    </div>
                    <div className="row">
                            <div className="col col-12 text-start mb-2 mt-2 copyright">
